...
import com.example.smartcounselling.Adapters.RecyclerListMessageAdapter;
import com.example.smartcounselling.Controllers.MessageController;
import com.example.smartcounselling.Fragments.AudioMessageFragment;
import com.example.smartcounselling.Interfaces.GetAudioFromRecordFragment;
...
import com.example.smartcounselling.Models.Message;
import com.example.smartcounselling.Models.RecentlyChat;
...
public class ChatWithFriendActivity extends AppCompatActivity implements ValueEventListener,
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (user != null) {
            nodeGetName = FirebaseDatabase.getInstance().getReference().child("patients").child(user.getUid());
        ...
        switch (v.getId()){
            ...
            case R.id.btnSendMessage:
                ...
                if(!contentMessage.isEmpty()){
                    ...
                    nodeGetMyName = FirebaseDatabase.getInstance().getReference().child("patients").child(uidFriendChat).child("status");

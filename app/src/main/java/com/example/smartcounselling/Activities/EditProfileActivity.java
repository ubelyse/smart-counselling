...
public class EditProfileActivity extends AppCompatActivity {
    ...
    private EditText txtFullName, txtAddress, txtPhoneNumber, txtDateOfBirth, txtDescription,txtRle,txtStatus;
    private RadioGroup radioGroupGender;
    private String uid, fullName, address, dateOfBirth, phoneNumber, description,userName,role,status;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        radioGroupGender = findViewById(R.id.radioGroupDisease);
        txtStatus = findViewById(R.id.editTextStatus);
        ...
        btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                account.setStatus(txtStatus.getText().toString().trim());
                ...
                databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if (snapshot.child("patients").child(uid).exists()){
                            databaseReference = firebaseDatabase.getReference().child("patients").child(uid);
        ...
        if (intent != null) {
            ...
            if (bundle != null) {
                ...
                account = new Account(userName, description, fullName, gender, address, phoneNumber, dateOfBirth, status);

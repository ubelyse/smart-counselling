...
import com.example.smartcounselling.Models.FriendRequest;
...
public class SearchProfileActivity extends AppCompatActivity {
    ...
    private TextView txtPhoneNumber, txtDateOfBirth, txtAddress,txtDisease, txtFullName, txtDescription;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtDisease = (TextView)findViewById(R.id.textViewDiseaseSearch);
        ...
        if(bundle != null){
            ...
            nodeRoot.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    DataSnapshot nodeUsers = dataSnapshot.child("patients");
                    ...
                    if (account != null) {
                        ...
                        DataSnapshot nodeUserSearch = dataSnapshot.child("patients");
                        ...
                        String disease = account.isDisease() ? "Addict" : "Depression";

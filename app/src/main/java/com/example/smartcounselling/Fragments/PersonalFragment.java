...
import com.example.smartcounselling.Activities.EditProfileActivity;
import com.example.smartcounselling.Activities.SearchProfileActivity;
        ...
        databaseReference.child("doctors").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (doctor != null) {
                    ...
                    txtAddress.setText(doctor.getAddress());
                    txtDescription.setText(doctor.getDescription());
                    txtStatu.setText(doctor.getRole());
        ...
        if(bitmap != null)
        {
            ...
            uploadTask.addOnFailureListener(new OnFailureListener() {
                ...
                public void onFailure(@NonNull Exception exception) {
                    Toast.makeText(getActivity(),"Do not receive photos, please check again!!",Toast.LENGTH_LONG).show();
                }
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.btnEditProfile:
                ...
                bundle.putBoolean("DISEASES",account.isDisease());
                ...
                mFirebaseAnalytics.logEvent("personal",bundle);
                break;
        }
    }
    ...
    public void changeAvatar(final boolean isNotify)
    {
        ...
        try {
            ...
            ref.getFile(localFile).addOnSuccessListener(new OnSuccessListener<FileDownloadTask.TaskSnapshot>() {
                ...
                public void onFailure(@NonNull Exception exception) {
                    if(isNotify)
                        Toast.makeText(getActivity(),"Avatar Change Failed",Toast.LENGTH_SHORT).show();
                }
        ...
        try {
            ...
            ref.getFile(localFile).addOnSuccessListener(new OnSuccessListener<FileDownloadTask.TaskSnapshot>() {
                ...
                public void onSuccess(FileDownloadTask.TaskSnapshot taskSnapshot) {
                    ...
                    if(isNotify)
                        Toast.makeText(getActivity(),"Wallpaper changed successfully",Toast.LENGTH_SHORT).show();
                }
            }).addOnFailureListener(new OnFailureListener() {
                @Override
                public void onFailure(@NonNull Exception exception) {
    ...
    public void deleteBackground() {
        ...
        desertRef.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onFailure(@NonNull Exception exception) {
                ...
                Toast.makeText(getActivity(), "Wallpaper Change Failed", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
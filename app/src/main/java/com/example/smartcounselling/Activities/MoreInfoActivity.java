...
import com.example.smartcounselling.Adapters.ListMediaStorageAdapter;
...
public class MoreInfoActivity extends AppCompatActivity implements ValueEventListener {
    ...
    private String uidFriend, nameFriend, emailFriend, phoneNumberFriend , ustatus;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (!iMoreInfo.getStringExtra("UID").isEmpty() && !iMoreInfo.getStringExtra("Name").isEmpty()) {
            ...
            ustatus = iMoreInfo.getStringExtra("Status");
            ...
            nodeUsers.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    DataSnapshot nodeUser=dataSnapshot.child("patients").child(uidFriend);
